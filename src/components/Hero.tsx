    ...
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <div className="animate-fade-in">
          ...
          <p className="text-xl md:text-2xl lg:text-3xl mb-8 text-gray-200 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              ...
              className="btn-gold text-lg px-8 py-4 h-auto font-semibold animate-glow"
            >
            ...
            <Button
              ...
              className="border-gold text-gold hover:bg-gold hover:text-black text-lg px-8 py-4 h-auto font-semibold"
            >
              Ver Galeria
            </Button>
          </div>
